...
import InspectionTasksView from '../views/production/InspectionTasksView.vue'
    ...
    { path: '/login', name: 'login', component: LoginView },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: InspectionTasksView,
          meta: { title: '检验任务', ...authRequired },
        },
